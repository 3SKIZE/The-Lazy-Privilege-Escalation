...
move %letter%:\The-Lazy-Privilege-Escalation-master\The-Lazy-Privilege-Escalation-master\* %letter%:
move %letter%:\The-Lazy-Privilege-Escalation-master\The-Lazy-Privilege-Escalation-master\Script\* %letter%:

rmdir The-Lazy-Privilege-Escalation-master
mkdir The-Lazy-Privilege-Escalation-master

cd The-Lazy-Privilege-Escalation-master
mkdir Script

move %letter%:\L.P.E.bat %letter%:\The-Lazy-Privilege-Escalation-master
move %letter%:\README.md %letter%:\The-Lazy-Privilege-Escalation-master
move %letter%:\README-requirements %letter%:\The-Lazy-Privilege-Escalation-master
 
move %letter%:\Check-exploit.bat %letter%:\The-Lazy-Privilege-Escalation-master\Script
move %letter%:\Check-privilege %letter%:\The-Lazy-Privilege-Escalation-master\Script
